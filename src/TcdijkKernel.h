...
#ifndef INCLUDED_TcdijkKERNEL
#define INCLUDED_TcdijkKERNEL

#include <LEDA/graph/ugraph.h>
#include <Leda/core/h_array.h>

class TcdijkKernelizer {
public:
	
	ugraph &g;
	node_map<bool> &blackedOut;
	...
	TcdijkKernelizer( ugraph &g, node_map<bool> &blackedOut, int k );
	TcdijkKernelizer( ugraph &g, node_map<bool> &blackedOut ); // get a valid k from the 2-approx
	...
	void blackedOutAdjacency( node v );
...
#endif //ndef INCLUDED_TcdijkKERNEL